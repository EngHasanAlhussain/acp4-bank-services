...
/**
 * Sample bank AuthService - loads JWT secret from environment/configuration.
 * Secret key is no longer hardcoded; it is read from the JWT_SECRET environment variable.
 */
    ...
    public AuthService() {
        ...
        if (secret == null || secret.isBlank()) {
            throw new IllegalStateException(
                ...
                + "Please configure a valid secret key."
            );
        }
